  ...
  if (!protocol_ok) {
    ...
    if (document.getElementById("custominput").value == "") {
      ...
      if (cre.test(document.getElementById("custominput").value)) {
        if (cinp()) {
          document.getElementById("erbox").style.color = "#01DC7F";
          document.getElementById("erbox").innerHTML = "Custom Address Available";
          genhash();
          send_request(longurl);
        } else {
          document.getElementById("erbox").style.color = "red";
          document.getElementById("erbox").innerHTML = "This custom address is already Used, Choose Another";
